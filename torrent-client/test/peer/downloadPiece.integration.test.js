...
// hoping it answers.
test('downloads a real piece from a real peer in the Sintel swarm and verifies its hash', { timeout: 45000 }, async () => {
  ...
  assert.ok(announceResult.peers.length > 0, 'need at least one peer from the tracker to run this test');
